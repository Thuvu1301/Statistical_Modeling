...
$$
\begin{aligned}
g(\text{salary\_in\_usd}) ={} & \beta_0 + \beta_1 \text{work\_year} + \boldsymbol{\beta}_2^{\mathsf T} \text{experience\_level} \\
& + \boldsymbol{\beta}_3^{\mathsf T} \text{employment\_type} + \boldsymbol{\beta}_4^{\mathsf T} \text{company\_size} \\
& + \boldsymbol{\beta}_5^{\mathsf T} \text{remote\_ratio} + \boldsymbol{\beta}_6^{\mathsf T} \text{job\_category} \\
& + \boldsymbol{\beta}_7^{\mathsf T} \text{company\_region} + \beta_8 \text{cross\_border} + \varepsilon
\end{aligned}
$$
...
**Phương pháp Box–Cox được đề xuất để lựa chọn phép biến đổi biến phản hồi một cách có hệ thống.** Với $Y=\text{salary\_in\_usd}>0$, phép biến đổi Box–Cox có dạng:
